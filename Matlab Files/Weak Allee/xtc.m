...
h=legend('c = 0.5','c = 0.7','c = 0.9',3)
xlabel('t');
ylabel('x');

function dy1 = Bqfun1(t,y)
dy1 = zeros(2,1);
r=2; K=50; theta=4; alpha=0.7; a=0.04; b=0.07; delta0=1; delta1=.3; c=0.5;
...
dy3 = zeros(2,1);
r=2; K=50; theta=4; alpha=0.7; a=0.04; b=0.07; delta0=1; delta1=.3; c=0.9;
