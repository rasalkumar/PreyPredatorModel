...
h=legend('delta1 = 0.4','delta1 = 0.3','delta1 = 0.2',3)
xlabel('t');
ylabel('x');

function dy1 = Bqfun1(t,y)
dy1 = zeros(2,1);
r=2; K=50; theta=4; alpha=0.7; a=0.04; b=0.07; delta0=1; delta1=.4; c=0.7;
...
dy3 = zeros(2,1);
r=2; K=50; theta=4; alpha=0.7; a=0.04; b=0.07; delta0=1; delta1=.2; c=0.7;
