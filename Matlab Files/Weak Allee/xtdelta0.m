...
h=legend('delta0 = 1','delta0 = 0.8','delta0 = 0.7',3)
xlabel('t');
ylabel('x');
...
dy2 = zeros(2,1);
r=2; K=50; theta=4; alpha=0.7; a=0.04; b=0.07; delta0=0.8; delta1=.3; c=0.7;
dy2=[(r*y(1)*(1-(y(1)/K))*((y(1))/(y(1)+theta))-(alpha*y(1)*y(2)/((1+a*y(1)+b*y(2)))))
    ((c*alpha*y(1)*y(2)/((1+a*y(1)+b*y(2))))-delta0*y(2)-delta1*y(2)*y(2))]

function dy3 = Bqfun3(t,y)
dy3 = zeros(2,1);
r=2; K=50; theta=4; alpha=0.7; a=0.04; b=0.07; delta0=0.7; delta1=.3; c=0.7;
