...
h=legend('a = 0.02','a = 0.04','a = 0.06',3)
xlabel('t');
ylabel('x');

function dy1 = Bqfun1(t,y)
dy1 = zeros(2,1);
r=0.5; K=10; beta=0.4; alpha=0.7; a=0.02; b=0.07; c=0.7; delta0=1;  delta1=.3;
...
dy3 = zeros(2,1);
r=0.5; K=10; beta=0.4; alpha=0.7; a=0.06; b=0.07; c=0.7; delta0=1;  delta1=.3;
