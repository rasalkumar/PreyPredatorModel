...
plot (T,Y(:,1),'b',T1,Y1(:,1),'r',T2,Y2(:,1),'g');
h=legend('delta0 = 0.9','delta0 = 1','delta0= 1.1',3)
xlabel('t');
ylabel('x');

function dy1 = Bqfun1(t,y)
dy1 = zeros(2,1);
r=0.5; K=10; beta=0.4; alpha=0.7; a=0.04; b=0.07; c=0.7; delta0=0.9;  delta1=.3;
...
dy3 = zeros(2,1);
r=0.5; K=10; beta=0.4; alpha=0.7; a=0.04; b=0.07; c=0.7; delta0=1.1;  delta1=.3;
